...
namespace Server
{
	public class GenTeleporter
	{
		...
		{
			Server.CommandSystem.Register("TelGen", AccessLevel.Administrator, new CommandEventHandler(GenTeleporter_OnCommand));
		}
		...
		public class TeleportersCreator
		{
			...
			public void CreateTeleportersMap2(Map map)
			{
				...
				*/
				...
				CreateTeleporter(371, 29, -36, 241, 25, -181, map, false); // stairs - 0x754
