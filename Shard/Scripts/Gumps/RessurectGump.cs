...
namespace Server.Gumps
{
	...
	public class ResurrectGump : Gump
	{
		...
		private bool StatLossCandidate(Mobile owner)
		{
			...
			return (owner.ShortTermMurders >= 5 && ((PlayerMobile)owner).Inmate == false && Server.Misc.AutoRestart.ServerWars == false);
		}
		...
		private bool StatLossReprieve(Mobile owner)
		{
			...
			if (owner == null) return false;
			return (owner.ShortTermMurders >= 5 && (((PlayerMobile)owner).Inmate == true || Server.Misc.AutoRestart.ServerWars == true));
		}
