...
namespace Server.Engines.Craft
{
	public class CraftGump : Gump
	{
		...
		private CraftGump(Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, CraftPage page)
			: base(30, 30) // eddited by sam for woodworking changes
		{
			m_From = from;
			...
			AddImageTiled(10, 37, 300, 380, 2624);//edited by sam to fix gump
			AddImageTiled(215, 37, 305, 380, 2624);//edited by sam to fix gump
			...
			AddHtmlLocalized(10, 50, 200, 100, 1044010, LabelColor, false, false); // <CENTER>CATEGORIES</CENTER>
			AddHtmlLocalized(215, 50, 305, 100, 1044011, LabelColor, false, false); // <CENTER>SELECTIONS</CENTER>
			//edited by sam removed notice tab

			AddButton(15, 400, 4017, 4019, 0, GumpButtonType.Reply, 0);
			AddHtmlLocalized(50, 400, 150, 18, 1011441, LabelColor, false, false); // EXIT

			AddButton(270, 400, 4005, 4007, GetButtonID(6, 2), GumpButtonType.Reply, 0);
			AddHtmlLocalized(305, 400, 150, 18, 1044013, LabelColor, false, false); // MAKE LAST
