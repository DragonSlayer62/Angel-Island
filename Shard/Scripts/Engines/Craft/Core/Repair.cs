...
namespace Server.Engines.Craft
{
	public class Repair
	{
		...
		public class RepairDeed : object
		{   // RunUO 2.0 compatibility thunk
			public double SkillLevel = 0;
			public bool Check(Mobile m) { return false; }
			public void Delete() { }
		}
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				else if (targeted is BaseClothing)
				{
					...
					else
					{
						...
						{
							clothing.MaxHitPoints -= (short)toWeaken;
							clothing.HitPoints = (short)Math.Max(0, clothing.HitPoints - toWeaken);
						}
