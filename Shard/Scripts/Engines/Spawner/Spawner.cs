...
namespace Server.Mobiles
{
	public class Spawner : Item
	{
		...
		#region Publish 4 Siege (!Core.UOAI && !Core.UOAR && !Core.UOMO && Core.Publish >= 4)
		/*
		 * Publish 4
		 * Shopkeeper Changes
		 ...
		 */
		private Memory m_badGuys = !Core.UOAI && !Core.UOAR && !Core.UOMO && Core.Publish >= 4 ? new Memory() : null;
		public Memory BadGuys { get { return m_badGuys; } }
		public override bool HandlesOnMovement { get { return (!Core.UOAI && !Core.UOAR && !Core.UOMO && Core.Publish >= 4) ? true : false; } }
