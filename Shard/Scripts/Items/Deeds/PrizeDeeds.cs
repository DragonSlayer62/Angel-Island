...
namespace Server.Items
{
	public class HomeDecoPrize : Item
	{
			...
			: base(0x14F0)
		{
			...
			m_Signature = String.Format("{2} Home Deco Prize: {0}/{1}", DateTime.Now.Month, DateTime.Now.Year, m_PlaceText);
			Name = String.Format("{2} Home Deco Prize Ticket: {0}/{1}", DateTime.Now.Month, DateTime.Now.Year, m_PlaceText);
		}
