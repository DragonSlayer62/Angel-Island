...
namespace Server.Items
{
	...
	public class CommodityDeed : Item
	{
		...
		public override void OnSingleClick(Mobile from)
		{
			...
			//if (m_Commodity != null)
			if (m_Type != null)
				from.Send(new UnicodeMessage(Serial, ItemID, MessageType.Label, 0x3B2, 3, "ENU", "", this.m_Description));
			//from.Send( new Server.Network.AsciiMessage( Serial, ItemID, Server.Network.MessageType.Label, 0x3B2, 3, "", this.Name) );
		}
