...
{
	public abstract class LockableContainer : TrapableContainer, ILockable, ILockpickable, ICraftable/*, todo IShipwreckedItem*/
	{
		...
		private TimeSpan m_AutoResetTime;
		AutoResetTimer m_AutoResetTimer;
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public TimeSpan AutoResetTime { get { return m_AutoResetTime; } set { m_AutoResetTime = value; } }
		...
		public virtual bool Locked
		{
			...
			set
			{
				...
				if (m_Locked == false && m_AutoReset == true)
				{
					if (m_AutoResetTimer == null || m_AutoResetTimer.Running == false)
					{
						m_AutoResetTimer = new AutoResetTimer(this, m_AutoResetTime);
		...
		*/
		...
		public override void Serialize(GenericWriter writer)
		{
			...
			// version 5
			writer.Write((bool)m_AutoReset);
			writer.Write(m_AutoResetTime);
