	...
	public class PotionKeg : Item
	{
		...
		public override int LabelNumber
		{
			...
			get
			{
				...
				if (!Core.UOAI && !Core.UOAR && !Core.UOMO && Core.Publish < 15)
					switch (m_Type)
					{
						case PotionEffect.Nightsight: return 1041611;		// "A keg of black liquid.";
						case PotionEffect.CureLesser: return 1041617;		// "A keg of yellow liquid.";
						case PotionEffect.Cure: return 1041617;				// "A keg of yellow liquid.";
						case PotionEffect.CureGreater: return 1041617;		// "A keg of yellow liquid.";
						...
						case PotionEffect.HealLesser: return 1041612;		// "A keg of orange liquid."
						case PotionEffect.Heal: return 1041612;				// "A keg of orange liquid."
						case PotionEffect.HealGreater: return 1041612;		// "A keg of orange liquid."
